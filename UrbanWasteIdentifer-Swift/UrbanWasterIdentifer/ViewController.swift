...
class ViewController: UIViewController {
    ...
    func configureDefaults() {
        // Create default data
        let defaults = [
            ClassResult(className: "General Waste (Landfill)", score: 0.3),
            ClassResult(className: "Mixed Color Glass", score: 0.3),
            ClassResult(className: "Mixed Recycle", score: 0.3),
            ClassResult(className: "Organic Waste (Compost)", score: 0.3)
        ]
